...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc3 = nn.Linear(84, 2) #2진 분류
        #self.fc3 = nn.Linear(84, 10) #10 --> cifar 10의
        #self.fc3 = nn.Linear(84, 2)  # 10 --> cat & dog 분류기
        #self.fc3 = nn.Linear(84, 10)  # 10 --> minist 분류기
...
def main():
    ...
    trainset = torchvision.datasets.ImageFolder("./data/mydata", transform=transform)
    ...
    #테스트 셋도 마찬가지
    testset = torchvision.datasets.ImageFolder("./data/mydata", transform=transform)
